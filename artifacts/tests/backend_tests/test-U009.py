...
class RiskAssessmentTest(unittest.TestCase):
    ...
    def test_set_age(self):
        test = RiskAssessment(20, True, True, True, True, True, 2, True, True, StateMetrics([100, 120], 110, 0.99, [0.15]))
    ...
    def test_set_sex(self):
        test = RiskAssessment(20, True, True, True, True, True, 2, True, True, StateMetrics([100, 120], 110, 0.99, [0.15]))
        self.assertEqual(test.sex, 1, 'Should be True')
        test.set_sex(False)
        self.assertEqual(test.sex, 0, 'Should be False')
        with self.assertRaises(Exception):
            test.set_sex(55)
    ...
    def test_risk_from_predicted_cases(self):
        metrics = StateMetrics([100, 120], 110, 0.99, [0.15])
        metrics.days_out = 1
        calcRisk = RiskAssessment(20, True, True, True, True, True, 2, True, True, metrics)
    ...
    def test_risk_assessment(self):
        metrics = StateMetrics([100, 120], 110, 0.99, [0.15])
        metrics.days_out = 1
        test = RiskAssessment(20, True, True, True, True, True, 2, True, True, metrics)
